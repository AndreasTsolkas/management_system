...
import { EmployeeToProjectModule } from 'src/modules/employee_to_project.module'
...
import { EmployeeToProjectController } from 'src/controllers/employee_to_project.controller';
...
@Module({
  imports: [ConfigModule.forRoot(),
    ...
    TypeOrmModule.forRoot({
      ...
      entities: [Employee, Department, Bonus, VacationRequest, Project, EmployeeToProject],
      synchronize: false,
    }),
    
    EmployeeModule, DepartmentModule, BonusModule, VacationRequestModule, ProjectModule, EmployeeToProjectModule],
  controllers: [AppController, EmployeeController, DepartmentController, BonusController, 
    VacationRequestController, ProjectController, EmployeeToProjectController],
  providers: [AppService, EmployeeService, DepartmentService, BonusService, VacationRequestService,
  ProjectService, EmployeeToProjectService],
})
